...
const MARQUES_DEFAUT = [
  ...
  // Modèles usuels ajoutés (transit ouest-africain) — 26/07/2026
  'TOYOTA CAMRY', 'TOYOTA RAV4', 'TOYOTA YARIS', 'TOYOTA AVENSIS', 'TOYOTA FORTUNER',
  'TOYOTA LAND CRUISER PRADO', 'TOYOTA CARINA', 'TOYOTA COASTER',
  'NISSAN SUNNY', 'NISSAN ALMERA', 'NISSAN X-TRAIL', 'NISSAN QASHQAI', 'NISSAN MICRA',
  'HYUNDAI ACCENT', 'HYUNDAI ELANTRA', 'HYUNDAI TUCSON', 'HYUNDAI SANTA FE',
  'HYUNDAI I10', 'HYUNDAI H100', 'HYUNDAI H1',
  'KIA RIO', 'KIA SPORTAGE', 'KIA PICANTO', 'KIA CERATO', 'KIA SORENTO',
  'MERCEDES C 200', 'MERCEDES E 250', 'MERCEDES ML 350', 'MERCEDES SPRINTER 313',
  'HONDA CIVIC', 'HONDA CR-V', 'FORD RANGER', 'FORD FOCUS',
  'PEUGEOT 301', 'PEUGEOT 508', 'SUZUKI SWIFT', 'MITSUBISHI PAJERO', 'MITSUBISHI CANTER',
]
