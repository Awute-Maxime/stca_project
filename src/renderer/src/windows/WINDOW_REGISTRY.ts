...
export const WINDOW_REGISTRY: Record<string, WindowConfig> = {
  ...
  enregistrement:           { title: 'Enregistrement des véhicules',                       defaultX: 130, defaultY:  74, width: 1176, height: 768 },
  ...
  'fichier.decodeurVin':            { title: 'Décodage du numéro de châssis (VIN)',              defaultX: 210, defaultY: 120, width: 800, height: 700 },
  ...
  'outils.posteImmat':              { title: 'Configuration des connexions',                     defaultX: 260, defaultY: 154, width: 720, height: 560 },
  ...
  'apercu.listeDestinations':       { title: 'Aperçu — Liste des destinations',                  defaultX: 240, defaultY:  30, width: 880, height: 860 },
  'edition.assureur':               { title: "Création / Modification d'un assureur",             defaultX: 180, defaultY:  90, width: 960, height: 640 },
  'edition.destination':            { title: 'Saisie des paramètres de destination',             defaultX: 300, defaultY: 150, width: 520, height: 560 },
